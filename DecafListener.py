...
class DecafListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by DecafParser#compileUnit.
    def enterCompileUnit(self, ctx:DecafParser.CompileUnitContext):
        pass

    # Exit a parse tree produced by DecafParser#compileUnit.
    def exitCompileUnit(self, ctx:DecafParser.CompileUnitContext):
        pass
